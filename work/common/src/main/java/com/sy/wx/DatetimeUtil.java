...
public class DatetimeUtil {
    ...
    public static String getStartTime(String time, Integer c) throws Exception {
        SimpleDateFormat format = new SimpleDateFormat("yyyyMM");
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(format.parse(time));
        calendar.add(Calendar.MONTH, -c + 1);
        format = new SimpleDateFormat("yyyyMMddHHmmss");
        return format.format(calendar.getTime());
    }

    public static String getTodayEndTime(String time) throws Exception {

        return time + "235959";
    }

    public static String getEndTime(String time, Integer c) throws Exception {
        SimpleDateFormat format = new SimpleDateFormat("yyyyMM");
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(format.parse(time));
        calendar.add(Calendar.MONTH, 1);
        ...
        return format.format(calendar.getTime()) + "235959";
    }
